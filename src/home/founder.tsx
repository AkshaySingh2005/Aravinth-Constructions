  ...
  return (
    <div className="py-20">
      ...
      <div className="text-center mb-12">
        ...
        <div className="w-24 h-1 bg-gradient-to-r from-[#7C3AED] to-[#884cee] mx-auto rounded-full"></div>
      </div>

      {/* Single Card */}

      <div className="max-w-7xl mx-auto bg-white rounded-2xl shadow-2xl overflow-hidden border-2 border-black">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-0">
          ...
          <div className="relative">
            ...
            <div className="absolute bottom-2 right-3 bg-gradient-to-r from-[#7C3AED] to-[#884cee] text-white rounded-xl p-4 shadow-lg">
          ...
          <div className="p-8 space-y-6">
            ...
            <div>
              ...
              <div className="text-lg text-[#7C3AED] font-semibold mb-3">
            ...
            {/* Philosophy Quote */}
            <div className="bg-gradient-to-r from-[#7C3AED] to-[#884cee] text-white p-6 rounded-xl">
