    ...
    <div className="text-white py-12">
      <div className="max-w-6xl mx-auto">
        <div className="text-center mb-8">
          <h2 className="text-4xl font-bold mb-12 text-[#884cee]">
            ...
            <div className="space-y-4">
              ...
              <div className="space-y-3">
                <p className="flex items-start">
                  <MapPin className="mr-3 mt-1 text-[#7C3AED]" size={35} />
                  <span>
                ...
                <p className="flex items-center">
                  <Phone className="mr-3 mt-1 text-[#7C3AED]" size={20} />
                  <span>
                    <strong>Phone:</strong> 98424 38323, 73394 68412
                  </span>
                </p>
                <p className="flex items-center">
                  <Mail className="mr-3 mt-1 text-[#7C3AED]" size={20} />
                  <span>
                    <strong>Email:</strong> aravinthcons@gmail.com
                  </span>
                </p>
                <p className="flex items-center">
                  <Globe className="mr-3 mt-1 text-[#7C3AED]" size={20} />
                  <span>
        ...
        <div className="border-t border-gray-700 pt-8 text-center">
          <p className="text-gray-400">
            © 2024 Aravinth Constructions. All rights reserved.
          </p>
        </div>
      </div>
    </div>
