      ...
      <div className="mt-12 md:mt-4">
        ...
        <div className="block md:hidden">
          <div className="text-center mb-8">
            <div className="bg-gradient-to-r from-[#7C3AED] to-[#884cee] text-white rounded-2xl px-6 py-4 shadow-xl mx-4">
          ...
          <div className="relative flex justify-center items-center">
            <div className="w-[500px] lg:w-[600px] h-[360px] lg:h-[440px] relative">
              ...
              <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 z-10">
                <div className="bg-gradient-to-r from-[#7C3AED] to-[#884cee] text-white rounded-2xl px-6 lg:px-8 py-4 lg:py-6 shadow-2xl">
                  <div className="text-center">
                    <h3 className="text-xl lg:text-2xl font-bold font-sans">Brand Promise</h3>
